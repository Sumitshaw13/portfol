...
const Navbar = () => {
    ...
    return (
        <div className="text-white/70 pt-6 relative z-50">
            ...
            <div className="hidden md:flex items-center px-4 py-2 mx-auto max-w-[400px]">
                <ul className="flex flex-row p-4 space-x-8">
                    {navLinks.map((link, index) => (
                        <li key={index}>
                            <Link href={link.path}>
                                <p className="hover:text-white">{link.title}</p>
                            </Link>
                        </li>
                    ))}
                    <li>
            ...
            <motion.div
                ...
                className="fixed left-0 top-0 w-full h-full z-40 bg-black/90 flex justify-center items-center md:hidden"
            >
                <ul className="text-4xl font-semibold text-center space-y-8">
                    ...
                    <li>
                        <a href="#contact" onClick={closeNav}>
                            <p className="hover:text-orange-400">Contact Me</p>
                        </a>
                    </li>
                </ul>
            </motion.div>
